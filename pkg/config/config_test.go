...
func TestLoadConfig_SanitizesGatewayHostFromEnv(t *testing.T) {
	t.Setenv("PICOCLAW_GATEWAY_HOST", "0.0.0.0 (safe explicit value)")
	...
	if cfg.Gateway.Host != "0.0.0.0" {
		t.Fatalf("gateway host = %q, want %q", cfg.Gateway.Host, "0.0.0.0")
	}
}
